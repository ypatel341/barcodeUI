...
const QUESTIONNAIRE = [{
  ...
  choices: ['On my local machine', 'In the cloud using Sauce Labs', 'In the cloud using Browserstack or Testingbot or a different service', 'I have my own Selenium cloud']
}, {
  type: 'input',
  name: 'hostname',
  ...
  validate: _utils.validateServiceAnswers
}, {
  type: 'input',
  name: 'outputDir',
