...
class SpecReporter extends _reporter.default {
  ...
  printReport(runner) {
    ...
    const output = [...this.getHeaderDisplay(runner), ...results, ...this.getCountDisplay(duration), ...this.getFailureDisplay(), ...this.getTestLink(runner)];
  ...
  getTestLink({
    ...
    const isSauceJob = config.hostname.includes('saucelabs') || config.capabilities && (config.capabilities['sauce:options'] || config.capabilities.tunnelIdentifier);
